              ...
              <ul className="menu-list">
                ...
                >
                  ...
                  >
                    ...
                    <li
                      className={
                        pathname === "/portfolio/interactive-link"
                          ? "active"
                          : ""
                      }
                    >
                ...
                <form>
                  ...
                  <div className="quick-search">
                    <ul>
                      <li>Quick Search :</li>
                      <li>
                        <Link href="#">Network Infrastructure,</Link>
                      </li>
                      <li>
                      ...
                      <li>
                        <Link href="#">Consulting &amp; Strategy,</Link>
                      </li>
                    </ul>
                  </div>
                </form>
